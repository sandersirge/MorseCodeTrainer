...
@pytest.fixture
def presenter(mock_morse_session, mock_text_session):
	"""Create a TranslationPresenter with mock sessions."""
	return TranslationPresenter(mock_morse_session, mock_text_session)
...
class TestTranslationPresenterAudioPath:
	...
	def test_audio_path_without_start_returns_none(self, presenter):
		assert presenter.audio_path() is None
